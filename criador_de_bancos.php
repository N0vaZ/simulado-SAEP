...
if (!file_exists($arquivoBanco)) {
    ...
    $db->exec("INSERT INTO usuarios (nome, email, curso, idade) VALUES ('Gabriel Kreischer', 'gabriel@exemplo.com', 'T.I', '17')");
    $db->exec("INSERT INTO usuarios (nome, email, curso, idade) VALUES ('Arthur Silva', 'arthur@exemplo.com', 'T.I', '17')");
